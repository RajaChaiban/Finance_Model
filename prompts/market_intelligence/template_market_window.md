...
role: user_template
source: src/agents/market_intelligence.py:371 (PromptManager.TEMPLATE_MARKET_WINDOW)
filled_by: market_intelligence.py:675 (query_market_window)
...
placeholders:
  ...
  - "{recent_deals}"  — formatted comparables block, see PromptManager.format_comparables (line 420)
  - "{market_data}"   — formatted market-data block, see PromptManager.format_deal_data (line 415)
note: |
