...
role: user_template
source: src/agents/market_intelligence.py PromptManager.TEMPLATE_DEAL_INTELLIGENCE
filled_by: market_intelligence.py:748 (query_deal_analysis) via str.format(...)
paired_system: prompts/market_intelligence/system_deal_analysis.md
calling_agent: ValidatorAgent.validator.py:107
placeholders:
  - "{asset_class}"   — ticker
  - "{deal_summary}"  — single deal dict formatted by format_deal_data
  - "{comparables}"   — list of corpus deals formatted by format_comparables
note: |
